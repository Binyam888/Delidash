...
const Footer = () => {
  return (
    <div className="foooter text-[#d9d9d9] bg-[#323232] flex flex-col gap-[20px] pt-[80px] px-[10%] mt-[100px]">
      <div className="footer-content w-[100%] grid grid-cols-[2fr,1fr,1fr] gap-[80px]">
        ...
        <div className="footer-co-center " id="footer-contets">
          <h2>COMPANY</h2>
          <ul>
            <li>Home</li>
            <li>About us</li>
        ...
        <div className="footer-co-right" id="footer-contets">
          <h2>GET IN TOUCH</h2>
          <ul>
